...
var cards: [Card] = [
    ...
    .init(cardColor: Color("Card 4"), name: "", cardDesc: "Hi my name is Wasi. I like sports and sleep", cardCon: "mohammad@wasi.com", cardNote: "Write notes about me here", proPic: Image("CP4"), cardPic: Image("Pic 3")),
]
